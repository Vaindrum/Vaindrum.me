  ...
  return (
    <section className='w-full py-20'>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We start with a detailed planning phase to ensure we have a clear roadmap for the project. This includes defining the scope, timeline, and resources needed."
         >
          <CanvasRevealEffect
            animationSpeed={5.1}
