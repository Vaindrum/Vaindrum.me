  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 p-5 md:p-16 md:w-[60vw] dark:border-zinc-700"
            style={{
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  ...
                  <span className="text-lg leading-[1.6] font-bold text-white">
                    {item.name}
                  </span>
